...
I also have a more [generic visualizer](/assets/swizzle-visualizer.html) that allows you to change bank size and number of banks per row (forewarning: I haven't tested this variant extensively. It seems to work pretty well in my limited testing.)
